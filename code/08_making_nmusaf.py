...
TEXTURE_PATH = 'nmusaf_textures.png'
...
EPR_BRICK = tex_coords((3, 2), (3, 2), (3, 2))
COMPOSITE_YELLOW = tex_coords((0, 3), (0, 3), (0, 3))

NMUSAF = [COMPOSITE_RED, COMPOSITE_BLUE, COMPOSITE_BLACK, COMPOSITE_GREY, 
          COMPOSITE_GREEN, EPR_BRICK, COMPOSITE_YELLOW]
...
class Model(object):
    ...
    def load_txt(self):
        ...
        """
        with open('nmusaf.txt', 'r') as file:
            line = file.readline()
            while line:
                line = line.split(" ")
    ...
    def save_txt(self):
        ...
        """
        with open('nmusaf.txt', 'w') as output:
    ...
    def get_block_index(self, num="", type=""):
        ...
        if not isinstance(num, str):
            return NMUSAF[int(num)]
        elif not isinstance(type, str):
            for i in xrange(0, len(NMUSAF)):
                if type == NMUSAF[i]:
                    return i
        print("Invalid Call")
...
class Window(pyglet.window.Window):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.inventory = [BRICK, GRASS, SAND, COMPOSITE_RED, COMPOSITE_BLUE, COMPOSITE_BLACK, COMPOSITE_GREY, COMPOSITE_GREEN, EPR_BRICK, COMPOSITE_YELLOW]

        # index into the selected inventory
    ...
    def on_key_press(self, symbol, modifiers):
        ...
        if symbol == key.W:
            ...
            index = self.inventory_index % len(self.inventory)
            self.block = self.inventory[index]
        elif symbol == key.E:
            self.inventory_index += 1
            index = self.inventory_index % len(self.inventory)
    ...
    def draw_label(self):
        ...
        elif self.block == COMPOSITE_YELLOW:
            blockSelectedString = "Composite Yellow"
        elif self.block == EPR_BRICK:
            blockSelectedString = "EPR Brick"
