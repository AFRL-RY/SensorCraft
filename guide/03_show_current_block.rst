...
wrong block accidentally.  A simple way to remedy this problem is to extend the
"draw_label" method which we talked about in the previous chapter that shows 
